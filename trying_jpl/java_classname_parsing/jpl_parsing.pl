...
% Character.isJavaIdentifierPart(cp) returns true.
% We have generated the runs of unicode character points and list them below.
% Generally, the code point would be below even 255 and so quickly found.
%
